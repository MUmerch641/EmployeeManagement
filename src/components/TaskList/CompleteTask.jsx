...
export default function CompleteTask({task}) {
  return (
    <div className='bg-blue-400 h-[30vh] w-[30%] rounded-xl flex-shrink-0  max-lg:h-[150px] max-lg:w-[150px] p-3 overflow-y-auto Scroll max-sm:w-full max-sm:rounded-none'>
